...
export function generateMarkdown(result: AuditResult): string {
  ...
  lines.push("# AuditDocs — AI Discoverability Audit Report");
  lines.push("");
  ...
  lines.push("---");
  lines.push("*Generated by AuditDocs — auditdocs.fun*");
...
export function generatePDF(result: AuditResult): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    doc.fontSize(24).font("Helvetica-Bold").text("AuditDocs — AI Discoverability Audit", { align: "center" });
    doc.moveDown(0.5);
    ...
    doc.text("Generated by AuditDocs — auditdocs.fun", 50, doc.page.height - 50, { align: "center" });
